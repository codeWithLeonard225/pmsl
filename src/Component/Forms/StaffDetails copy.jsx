...
const handleSubmit = async (event) => {
    ...
    type="submit"
    disabled={submitting}
    className="w-full py-3 bg-indigo-600 text-white rounded-md font-bold text-lg hover:bg-indigo-700 shadow-lg disabled:opacity-50"
>
    {submitting ? "Saving..." : (editingStaffId ? 'Update Record' : 'Save Registration')}
</button>
                    </div>
                </form>
            </div>
